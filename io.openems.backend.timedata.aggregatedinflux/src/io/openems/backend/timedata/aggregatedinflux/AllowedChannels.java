...
public final class AllowedChannels {
	...
	static {
		...
		ALLOWED_CUMULATED_CHANNELS = ImmutableMap.<String, DataType>builder() //
				...
				.putAll(multiChannels(evcs, "ActiveConsumptionEnergyCost", DataType.DOUBLE)) //
				.putAll(multiChannels(evcs, "ActiveConsumptionEnergyEmissions", DataType.DOUBLE)) //
				...
				.putAll(multiChannels(meter, "ActiveConsumptionEnergyCost", DataType.DOUBLE)) //
				.putAll(multiChannels(meter, "ActiveConsumptionEnergyEmissions", DataType.DOUBLE)) //
