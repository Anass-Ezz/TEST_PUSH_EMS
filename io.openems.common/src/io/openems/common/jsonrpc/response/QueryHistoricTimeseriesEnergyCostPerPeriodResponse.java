...
/**
 * Represents a JSON-RPC Response for 'queryHistoricTimeseriesEnergyCostPerPeriod'.
 *
 * <pre>
 * {
 *   "jsonrpc": "2.0",
 ...
 * </pre>
 */
public class QueryHistoricTimeseriesEnergyCostPerPeriodResponse extends JsonrpcResponseSuccess {

	private final SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table;

	public QueryHistoricTimeseriesEnergyCostPerPeriodResponse(
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		this(UUID.randomUUID(), table);
	}

	public QueryHistoricTimeseriesEnergyCostPerPeriodResponse(UUID id,
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		super(id);
		this.table = table;
	}
