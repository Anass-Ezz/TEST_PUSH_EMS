...
/**
 * Represents a JSON-RPC Response for 'queryHistoricTimeseriesEnergyEmissionsPerPeriod'.
 *
 * <pre>
 * {
 *   "jsonrpc": "2.0",
 ...
 * </pre>
 */
public class QueryHistoricTimeseriesEnergyEmissionsPerPeriodResponse extends JsonrpcResponseSuccess {

	private final SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table;

	public QueryHistoricTimeseriesEnergyEmissionsPerPeriodResponse(
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		this(UUID.randomUUID(), table);
	}

	public QueryHistoricTimeseriesEnergyEmissionsPerPeriodResponse(UUID id,
			SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		super(id);
		this.table = table;
	}
