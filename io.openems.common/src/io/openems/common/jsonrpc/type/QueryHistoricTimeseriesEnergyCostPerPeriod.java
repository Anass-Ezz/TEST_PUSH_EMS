...
import io.openems.common.jsonrpc.type.QueryHistoricTimeseriesEnergyCostPerPeriod.Request;
import io.openems.common.jsonrpc.type.QueryHistoricTimeseriesEnergyCostPerPeriod.Response;
import io.openems.common.timedata.Resolution;
import io.openems.common.types.ChannelAddress;
import io.openems.common.utils.JsonUtils;

public class QueryHistoricTimeseriesEnergyCostPerPeriod implements EndpointRequestType<Request, Response> {

	@Override
	public String getMethod() {
		return "queryHistoricTimeseriesEnergyCostPerPeriod";
	}
	...
	public record Request(//
		 ...
		 * {@link QueryHistoricTimeseriesEnergyCostPerPeriod}.
		 * 
	...
	public record Response(SortedMap<ZonedDateTime, SortedMap<ChannelAddress, JsonElement>> table) {
		...
		/**
		 * Returns a {@link JsonSerializer} for a
		 * {@link QueryHistoricTimeseriesEnergyCostPerPeriod.Response}.
		 * 
		 * @return the created {@link JsonSerializer}
		 */
		public static JsonSerializer<QueryHistoricTimeseriesEnergyCostPerPeriod.Response> serializer() {
			return jsonObjectSerializer(QueryHistoricTimeseriesEnergyCostPerPeriod.Response.class, json -> {
