...
public abstract class AbstractSocomecMeter extends AbstractOpenemsModbusComponent
    ...
    /**
     * Applies the modbus protocol for Socomec Diris A20 and A40.
     *
     * @throws OpenemsException on error
     */
    protected abstract void identifiedDirisA20_A40() throws OpenemsException;
    ...
    protected final void identifySocomecMeter() {
        this.getSocomecIdentifier().thenAccept(name -> {
            try {
                ...
                } else if (name.startsWith("diris a-20") || name.startsWith("diris a20")) {
                    this.logInfo(this.log, "Identified Socomec Diris A20 meter");
                    this.identifiedDirisA20_A40();
 
                } else if (name.startsWith("diris a-40") || name.startsWith("diris a40")) {
                    this.logInfo(this.log, "Identified Socomec Diris A40 meter");
                    this.identifiedDirisA20_A40();
