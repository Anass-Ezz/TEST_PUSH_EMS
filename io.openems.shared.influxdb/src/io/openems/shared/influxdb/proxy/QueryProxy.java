...
public abstract class QueryProxy {
	...
	/**
	 * Queries historic data and aggregates all values within the given range into
	 * a single scalar per channel using the specified aggregation function.
	 *
	 * @param influxConnection    a Influx-Connection
	 * @param bucket              the bucket name; 'database/retentionPolicy' for
	 *                            InfluxDB v1
	 ...
	 * @throws OpenemsNamedException on error
	 */
	public abstract SortedMap<ChannelAddress, JsonElement> queryHistoricDataAggregated(//
			InfluxConnection influxConnection, //
			String bucket, //
			String measurement, //
			Optional<Integer> influxEdgeId, //
	...
	protected abstract String buildHistoricDataAggregatedQuery(//
			String bucket, //
			String measurement, //
			Optional<Integer> influxEdgeId, //
			ZonedDateTime fromDate, //
